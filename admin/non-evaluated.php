...
<caption><div class="pagination">
  <ul>
    <li class="active"><a href="student.php"><font color="#000000">All</font></a></li>
...
<caption><div class="pagination">
  <ul>
    ...
    <li><a href="evaluated.php"><font color="#000000">Evaluated</font></a></li>
    <li><a href="non-evaluated.php"><font color="#000000">Non-Evaluate</font></a></li>
...
<?php
$result= mysql_query("select *from student where status='Non-Evaluate'") or die (mysql_error());
