...
<a href="add_student.php" class="btn btn-inverse"><i class="icon-plus-sign"></i>&nbsp;Add Student Account</a>
...
<caption><div class="pagination">
  <ul>
    ...
    <li><a href="bsisstudent.php"><font color="#000000">BSIS</font></a></li>
    <li><a href="bscestudent.php"><font color="#000000">BSCE</font></a></li>
	<!---
    <li class="active"><a href="bshrmstudent.php"><font color="#000000">BSHRM</font></a></li>
    <li><a href="bsitstudent.php"><font color="#000000">BSIT</a></font></li>
	-->
...
<?php
$result= mysql_query("select *from student where program='BSHRM'") or die (mysql_error());
