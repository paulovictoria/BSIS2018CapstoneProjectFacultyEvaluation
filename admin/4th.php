...
<?php
$result= mysql_query("select *from student where yr = '4th'") or die (mysql_error());
...
<td width = "180"> 
  <a href="editstudent_1st.php<?php echo '?id='.$id; ?>" class="btn btn-info"><i class="icon-pencil icon-large"></i>Edit</a>
