...
<title>Applicants | Teacher</title>
...
<center><legend><h3>Teacher's Account Applicants List</h3></legend></center>
...
<tbody>
<?php
$result= mysql_query("select *from teacher where approved=0") or die (mysql_error());
...
<td style="text-align:center; width:201px;">
 <a href="#app<?php echo $id; ?>" data-toggle="modal" class="btn btn-inverse" ><i></i> Approve</a>
 <a href="#denyteach<?php echo $id?>"  data-toggle="modal"  class="btn btn-danger" ><i></i> Deny</a>
</td>
...
<p><div class="alert alert-danger">Are you Sure you want APPROVE?</p>
</div>
<hr>
<div class="modal-footer">
<a href="approve_teach.php<?php echo '?id_teacher='.$id; ?>" class="btn btn-danger"><i class="icon-ok icon-large"></i> Yes</a>
...
<?php include('denyteach_modal.php'); ?>
