...
<caption><div class="pagination">
  <ul>
    ...
    <li class="active"><a href="BSIS.php"><font color="#000000">BSIS</font></a></li>
...
<tbody>
<?php
$result= mysql_query("select *from teacher where program='BSIS' group by subject, sec, yr, teacherid") or die (mysql_error());
