...
<caption><div class="pagination">
  <ul>
    ...
    <li class="active"><a href="ccm.php"><font color="#000000">CCM</font></a></li>
...
<tbody>
<?php
$result= mysql_query("select *from teacher where program='CCM' group by subject, sec, yr, teacherid") or die (mysql_error());
