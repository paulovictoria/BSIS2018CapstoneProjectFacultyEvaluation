...
<div class="span12">
    ...
    <li class="active"><a href="bshrmdept.php"><font color="#000000">BSHRM</font></a></li>
    <li><a href="bsitdept.php"><font color="#000000">BSIT</a></font></li>
...
<tbody>
<?php
$result= mysql_query("select *from teacher where program='BSHRM'") or die (mysql_error());
