...
<a href="#del" data-toggle="modal" class="btn btn-danger">Expire All Account</a>
...
<?php
$result= mysql_query("select * from student where approved=1") or die (mysql_error());
...
<td width = "180"> 
    <a href="#<?php echo $id?>"  data-toggle="modal"  class="btn btn-danger" ><i></i> DROP</a>
  </td>
    <!-- Modal -->
...
<?php include('deletestud_modal.php'); ?>
</div>
</div>
</div>
</div>
