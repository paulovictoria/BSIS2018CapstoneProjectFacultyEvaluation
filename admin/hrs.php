...
<caption><div class="pagination">
  <ul>
    ...
    <li class="active"><a href="hrs.php"><font color="#000000">HRS</font></a></li>
...
<tbody>
<?php
$result= mysql_query("select *from teacher where program='HRS' group by subject, sec, yr, teacherid") or die (mysql_error());
