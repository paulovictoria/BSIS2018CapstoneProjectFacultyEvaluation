...
<caption><div class="pagination">
  <ul>
	...
	<!---
    <li><a href="bshrmstudent.php"><font color="#000000">BSHRM</font></a></li>
    <li class="active"><a href="bsitstudent.php"><font color="#000000">BSIT</a></font></li>
	-->
...
<?php
$result= mysql_query("select *from student where program='BSIT'") or die (mysql_error());
