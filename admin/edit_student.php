...
$row=mysql_fetch_array($query);
 ...
 <form class="form-horizontal" method="post"  enctype="multipart/form-data">
                                <legend><h4>Edit Student's Account</h4></legend>
                                    ...
                                    <div class="controls">
                                        <input type="text" name="id_number" value="<?php echo $row['id_number']; ?>" style="height:30px; margin-right:10px; " />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="inputPassword">First Name:</label>
                                    <div class="controls">
                                        <input type="text" name="fname" value="<?php echo $row['fname']; ?>" style="height:30px; margin-right:10px; " />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="inputPassword">Middle Name:</label>
                                    <div class="controls">
                                        <input type="text" name="mname" value="<?php echo $row['mname']; ?>" style="height:30px; margin-right:10px; " />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="inputPassword">Last Name:</label>
                                    <div class="controls">
                                        <input type="text" name="lname" value="<?php echo $row['lname']; ?>" style="height:30px; margin-right:10px; " />
                                    </div>
                                </div>
																<div class="control-group">
