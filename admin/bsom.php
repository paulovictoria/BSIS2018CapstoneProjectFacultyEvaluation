...
<caption><div class="pagination">
  <ul>
    ...
    <li class="active"><a href="bsom.php"><font color="#000000">BSOM</font></a></li>
...
<tbody>
<?php
$result= mysql_query("select *from teacher where program='BSOM' group by subject, sec, yr, teacherid") or die (mysql_error());
