...
<legend>Student Evaluation List</legend>
      ...
      <table class="table table-bordered  table-hover" id="example">
		   ...
		   <tbody>
			...
			if(isset($_POST['submit']))
			{
$teachers = mysql_query("SELECT *, (SELECT SUM(avetotal) FROM details WHERE details.teacherid = teacher.teacherid AND details.semester = '".$_POST['semester']."' AND details.sy = '".$_POST['schoolyear']."' AND details.rater = 'student') AS aveTotal,
					   (SELECT SUM(ave1) FROM details WHERE details.teacherid = teacher.teacherid AND details.semester = '".$_POST['semester']."' AND details.sy = '".$_POST['schoolyear']."' AND details.rater = 'student') AS ave1, 
					   (SELECT SUM(ave2) FROM details WHERE details.teacherid = teacher.teacherid AND details.semester = '".$_POST['semester']."' AND details.sy = '".$_POST['schoolyear']."' AND details.rater = 'student') AS ave2, 
					   (SELECT SUM(ave3) FROM details WHERE details.teacherid = teacher.teacherid AND details.semester = '".$_POST['semester']."' AND details.sy = '".$_POST['schoolyear']."' AND details.rater = 'student') AS ave3, 
					   (SELECT SUM(ave4) FROM details WHERE details.teacherid = teacher.teacherid AND details.semester = '".$_POST['semester']."' AND details.sy = '".$_POST['schoolyear']."' AND details.rater = 'student') AS ave4, 
					   (SELECT SUM(ave5) FROM details WHERE details.teacherid = teacher.teacherid AND details.semester = '".$_POST['semester']."' AND details.sy = '".$_POST['schoolyear']."' AND details.rater = 'student') AS ave5,
					   (SELECT COUNT(*) FROM details WHERE details.teacherid = teacher.teacherid AND details.semester = '".$_POST['semester']."' AND details.sy = '".$_POST['schoolyear']."' AND details.rater = 'student') AS evaluateCount FROM teacher group by fname");
			}
			else
			{
$teachers = mysql_query("SELECT *, (SELECT SUM(avetotal) FROM details WHERE details.teacherid = teacher.teacherid AND details.rater = 'student') AS aveTotal, 
					   (SELECT SUM(ave1) FROM details WHERE details.teacherid = teacher.teacherid AND details.rater = 'student') AS ave1, 
					   (SELECT SUM(ave2) FROM details WHERE details.teacherid = teacher.teacherid AND details.rater = 'student') AS ave2, 
					   (SELECT SUM(ave3) FROM details WHERE details.teacherid = teacher.teacherid AND details.rater = 'student') AS ave3, 
					   (SELECT SUM(ave4) FROM details WHERE details.teacherid = teacher.teacherid AND details.rater = 'student') AS ave4, 
					   (SELECT SUM(ave5) FROM details WHERE details.teacherid = teacher.teacherid AND details.rater = 'student') AS ave5, 
