...
<caption><div class="pagination">
  <ul>
    ...
    <li class="active"><a href="comsec.php"><font color="#000000">ComSec</font></a></li>
...
<tbody>
<?php
$result= mysql_query("select *from teacher where program='ComSec' group by subject, sec, yr, teacherid") or die (mysql_error());
