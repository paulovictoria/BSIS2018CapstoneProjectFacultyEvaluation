...
--
-- Host: localhost
-- Generation Time: Mar 10, 2015 at 10:55 PM
...
INSERT INTO `details` (`id_teacher`, `teacherid`, `fname`, `lname`, `subject`, `semester`, `program`, `sy`, `ave1`, `ave2`, `ave3`, `ave4`, `ave5`, `avetotal`, `comment`, `rater`) VALUES
(1, 21200531, 'Aladin', 'Cabrera', 'IS 302', '1st', 'BSIS', 2012, 5, 5, 5, 5, '5', 5, '', 'student'),
(2, 21200531, 'Aladin', 'Cabrera', 'IS 302', '1st', 'BSIS', 2012, 1, 2, 4, 4, '', 2, '', 'dean/chairperson'),
(3, 21200533, 'Charito', 'Puray', 'IS 323', '1st', 'BSIS', 2012, 5, 5, 5, 5, '', 5, '', 'dean/chairperson'),
(4, 21200533, 'Charito', 'Puray', 'IS 323', '1st', 'BSIS', 2012, 5, 5, 5, 5, '5', 5, '', 'student');
