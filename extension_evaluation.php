...
<div id="content">    
 ...
 mysql_query("INSERT INTO details (id_professor, fname, lname, semester, sy, s1, s2, s3, s4, suptotal, rater)
    VALUES('$id_professor','$fname', '$lname', '$semester', '$sy', '$s1', '$s2', '$s3', '$s4', '$suptotal' , '$rater')")or die(mysql_error());
      ...
      <tr>
        <td>
          <label class="radio inline" style="margin-right: 35px;">
            <input type="radio" name="rater" id="inlineoptionsRadios1" value="category3" checked>Extension Service
