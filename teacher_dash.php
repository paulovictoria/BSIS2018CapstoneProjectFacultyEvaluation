...
<?php include ('menunav2.php'); ?>
<?php

$query = mysql_query("select * from professor where id_prof = '$ses_id' ")or die(mysql_error());
...
<div class="container">
  <?php include('menunav.php'); ?>
    <div class="row-fluid">
<center><h4><div class="alert alert-info">Welcome <h3>"<?php echo $row['fnamee']?> <?php echo $row['lnamee']?>"</h3></center></div>
