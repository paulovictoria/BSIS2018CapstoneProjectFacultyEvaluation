...
<div id="content">    
 ...
 mysql_query("INSERT INTO details (id_professor, fname, lname, semester, sy, s1, s2, s3, suptotal, rater)
    VALUES('$id_professor','$fname', '$lname' ,'$semester' ,'$sy' , '$s1', '$s2', '$s3', '$suptotal' , '$rater')")or die(mysql_error());
      ...
      <tr>
        <td>
          <label class="radio inline" style="margin-right: 35px;">
            <input type="radio" name="rater" id="inlineoptionsRadios1" value="category4" checked>VPPREQA
...
<!--commitment-->
        <thead>
        <th class="alert alert-info"><center><strong><font color="#2B547E">Contributions to School and Community Services(VPPREQA)</th>
        <th class="alert alert-info"><center><strong><font color="#2B547E">Scale</th>
        </thead>
        
        
      <tr>
        <td>A. Services on School Committees. </td>
        <td width = "190">
        ...
        <tr>
        <td>B. Attendance and participation.</td>
        <td width = "190">
       ...
       <tr class="alert alert-block">
        ...
        <tr>
        <td>C. Related Performance in Community Services.  </td>
        <td width = "190">
