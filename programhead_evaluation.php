...
<div id="content">    
 ...
 mysql_query("INSERT INTO details (teacherid, fname, lname, semester, sy, s1, s2, s3, s4, s5, s6, suptotal, rater)
    VALUES('$teacherid','$fname', '$lname', '$semester' , '$sy' , '$s1', '$s2', '$s3', '$s4', '$s5', '$s6', '$suptotal', '$rater')")or die(mysql_error());
      ...
      <tr>
        <td>
          <label class="radio inline" style="margin-right: 35px;">
            <input type="radio" name="rater" id="inlineoptionsRadios1" value="category2" checked>Program Head
...
<!--commitment-->
        <thead>
        <th class="alert alert-info"><center><strong><font color="#2B547E">Contribution to the Discipline/Division(Program Head)</th>
        <th class="alert alert-info"><center><strong><font color="#2B547E">Scale</th>
        </thead>
        
        
      <tr>
        <td>A. Serves on Departmental committees. </td>
        <td width = "190">
        ...
        <tr>
        <td>B. Coordination efforts on courses/programs in the discipline.</td>
        <td width = "190">
       ...
       <tr class="alert alert-block">
        ...
        <tr>
        <td>C. Conducted course/program revision and development.  </td>
        <td width = "190">
       ...
       <tr class="alert alert-block">
        ...
        <tr>
        <td>D. Participation in course/programs in the discipline.</td>
        <td width = "190">
        ...
        <tr>
        <td>E. Mentors/evaluated junior/adjunct faculty.</td>
        <td width = "190">
        ...
        <tr class="alert alert-block">
             <td align="right"><b></b></td>
             <td align="center"><input value="5.00" name="s5" id="fifth" readonly="readonly" size="3" type="hidden" readonly="readonly" class="span5 totalClass"></td>
             </tr>
       
         <tr>
        <td>F. Conducted assessment studies of Student Learning Outcomes(SLOs).</td>
        <td width = "190">
        
        <label class="radio inline">
          <input type="radio" name="c5" id="inlineoptionsRadios1" class="sixth" value="1" required>1
          </label>                                                  
        <label class="radio inline">                                
          <input type="radio" name="c5" id="inlineoptionsRadios2" class="sixth" value="2" required>2
          </label>                                                  
         <label class="radio inline">                               
          <input type="radio" name="c5" id="inlineoptionsRadios3" class="sixth" value="3" required>3
          </label>                                                  
         <label class="radio inline">                               
          <input type="radio" name="c5" id="inlineoptionsRadios4" class="sixth" value="4" required>4
          </label>                                                  
        <label class="radio inline">                                
          <input type="radio" name="c5" id="inlineoptionsRadios5" class="sixth" value="5" checked>5
          </label>
        ...
        <tr class="alert alert-block">
             <td align="right"><b></b></td>
             <td align="center"><input value="5.00" name="s6" id="sixth" readonly="readonly" size="3" type="hidden" readonly="readonly" class="span5 totalClass"></td>
             </tr>
