...
<div id="content">    
 ...
 mysql_query("INSERT INTO details (id_professor, fname, lname, semester, sy, s1, s2, s3, s4, s5, suptotal, rater,role)
    VALUES('$id_professor','$fname', '$lname', '$semester', '$sy' , '$s1', '$s2', '$s3', '$s4', '$s5', '$suptotal', '$rater','$role')")or die(mysql_error());
      ...
      <tr>
        <td>
          <label class="radio inline" style="margin-right: 35px;">
            <input type="radio" name="rater" id="inlineoptionsRadios1" value="category1" checked>College President
...
<!--commitment-->
        <thead>
        <th class="alert alert-info"><center><strong><font color="#2B547E">Effectiveness as a Teacher(VPAA and College President)</th>
        <th class="alert alert-info"><center><strong><font color="#2B547E">Scale</th>
        </thead>
        
        
      <tr>
        <td>A. Command of subject matter. </td>
        <td width = "190">
        ...
        <tr>
        <td>B. Effective teaching/learning strategies.</td>
        <td width = "190">
       ...
       <tr class="alert alert-block">
        ...
        <tr>
        <td>D. Plan for class observed; syllabus showing learning outcomes/objectives and appropriate
...
.</td>
        ...
        <tr>
        <td>C. Teaching materials and methods.</td>
        <td width = "190">
