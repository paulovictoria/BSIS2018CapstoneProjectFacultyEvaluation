...
<div class="hero-unit">
  ...
  //  $evaluationInfo = mysql_fetch_assoc($checkIfEvaluated);
    ?>
     ...
     <td width="190">
     <a href="dean_evaluation.php?id_proof=<?php echo $id; ?>" <?php echo (!empty($evaluationInfo)) ? "disabled onclick='return false;' " : ""; ?> class="btn btn-info"><i class="icon-pencil icon-large"></i>&nbsp;Evaluate</a>
